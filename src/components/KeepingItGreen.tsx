...
export function KeepingItGreen({
  title,
  leftImage,
  rightImage,
}: KeepingItGreenProps) {
    ...
    <div className="container">
      ...
      <div className="threeUp">
        <div
          ...
          style={{ "--media-bg": "#cfe7c7" } as CSSProperties}
        >
          {leftImage?.src ? (
        ...
        <div className="card">
          ...
          <p>
            From our plant-based recipes to our glass bottles, it's central to
            who we are.
          </p>
        ...
        <div
          className="frameMedia"
          style={{ "--media-bg": "#e8edf5" } as CSSProperties}
        >
          {rightImage?.src ? (
