...
export const categoryTiles: CategoryTile[] = [
  {
    ...
    href: "#",
    mediaBg: "#f2d7b8",
    imageSrc: getImage("multiple_bottles_1.webp"),
  },
  {
    label: "Kombuchas",
    href: "#",
    mediaBg: "#f2dbe9",
    imageSrc: getImage("multiple_bottles_2.webp"),
  },
  {
    label: "Cold-pressed Juices",
    href: "#",
    mediaBg: "#cfe4ee",
    imageSrc: getImage("multiple_bottles_3.webp"),
  },
];

export const quoteBlock: QuoteBlock = {
  quote:
    '"This spicy, pocket-sized booster is the healthy kickstart I need to start my day."',
  author: "— JANE S.",
...
export const promoBlock: PromoBlock = {
  title: "Take a sip",
  body: "Sweet, tart, and oh-so-refreshing, our low-sugar, probiotic lemonades taste like summer in a bottle.",
  cta: "Shop Lemonades",
